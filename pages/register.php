            ...
            <div class="container">
                <div class="col-sm-10 offset-1">
                	<div class="register-wrap ">
						...
						<?php } ?>	
						<?php } ?>
                	<form class="form" method="post" action="/capstone3/api/register-api.php">
	                	<div class="col-sm-12 header-top-head">
	                		<div class="row">
		                		...
		                		<div class="col-sm-6 text-right">
		                			<div class="form-group">
		                				<label>Precinct No.
		                					<input type="text" name="precinct_no" class="form-control" placeholder="Type your precinct number" required="">
		                				</label>
		                			</div>	                			
		                		</div>
	                		</div>
		                						...
		                						<div class="form-check">
	                                                <div class="checkbox">
	                                                    <label for="checkbox1" class="form-check-label ">
	                                                        <input type="checkbox" id="checkbox1" name="illiterate" value="1" class="form-check-input"> &nbsp;Illiterate
	                                                    </label>
	                                                </div>
	                                                <div class="checkbox">
	                                                    <label for="checkbox2" class="form-check-label ">
	                                                        <input type="checkbox" id="checkbox2" name="indigent" value="1" class="form-check-input"> &nbsp;Indigenous People
	                                                    </label>
	                                                </div>
	                                                <div class="checkbox">
	                                                    <label for="checkbox3" class="form-check-label ">
	                                                        <input type="checkbox" id="checkbox3" name="pwd" value="1" class="form-check-input"> &nbsp;Person with Disability
	                                                    </label>
	                                                </div>
	                                            </div>
	                                            <div class="form-group">
